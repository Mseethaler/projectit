 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */di();fn([{"revision":null,"url":"assets/AllocateEmployees-Dh0pK2HE.js"},{"revision":null,"url":"assets/dayjs.min-b3Wsfq-H.js"},{"revision":null,"url":"assets/Dialog-DmeKa7P_.js"},{"revision":null,"url":"assets/EditInstructions-CJYUXNXH.js"},{"revision":null,"url":"assets/ErrorMessage-C3Mx-1-k.js"},{"revision":null,"url":"assets/Home-Do5Y_zct.js"},{"revision":null,"url":"assets/index-2BoOF11I.js"},{"revision":null,"url":"assets/index-B6GJqtEw.css"},{"revision":null,"url":"assets/index-BUg-47se.js"},{"revision":null,"url":"assets/Login-Yq1N_OeJ.js"},{"revision":null,"url":"assets/ManageIT-BUn8PyIx.js"},{"revision":null,"url":"assets/RouteIT-C2G1QiMX.js"},{"revision":null,"url":"assets/StatusBadge-Bu_Z0Khh.js"},{"revision":null,"url":"assets/StopDetail-BhR-57Dt.js"},{"revision":null,"url":"assets/Tab-BuwO-LgH.js"},{"revision":null,"url":"assets/TeamMembers-BZeOVU0k.js"},{"revision":null,"url":"assets/WorkIT-DIgwZ3u8.css"},{"revision":null,"url":"assets/WorkIT-DudjAbqO.js"},{"revision":"284e22001d8d3f2dd911b42c803f4fc1","url":"index.html"},{"revision":"c99db7bcfee64c71a7a3eda8c64ea230","url":"manifest.webmanifest"}]);hn();const bi=new URL(location).searchParams.get("config");try{let n=function(){return navigator.userAgent.toLowerCase().includes("chrome")};const t=st(JSON.parse(bi)),e=gi(t);mi(e,r=>{const s=r.data.title;let i={body:r.data.body||""};r.data.notification_icon&&(i.icon=r.data.notification_icon),n()?i.data={url:r.data.click_action}:r.data.click_action&&(i.actions=[{action:r.data.click_action,title:"View Details"}]),self.registration.showNotification(s,i)}),n()&&self.addEventListener("notificationclick",r=>{r.stopImmediatePropagation(),r.notification.close(),r.notification.data&&r.notification.data.url&&clients.openWindow(r.notification.data.url)})}catch(t){console.log("Failed to initialize Firebase",t)}self.skipWaiting();pn();console.log("Service Worker Initialized");
