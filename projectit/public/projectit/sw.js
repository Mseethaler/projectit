 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */di();fn([{"revision":null,"url":"assets/AllocateEmployees-dXNpVm_4.js"},{"revision":null,"url":"assets/dayjs.min-yzg8hwP0.js"},{"revision":null,"url":"assets/Dialog-D_ibHD4z.js"},{"revision":null,"url":"assets/EditInstructions-BwOYi46m.js"},{"revision":null,"url":"assets/ErrorMessage-p7lx37yl.js"},{"revision":null,"url":"assets/Home-CPdjOXD3.js"},{"revision":null,"url":"assets/index-B6GJqtEw.css"},{"revision":null,"url":"assets/index-COruTYUZ.js"},{"revision":null,"url":"assets/index-DAUH4XRW.js"},{"revision":null,"url":"assets/Login-CLqmCGcB.js"},{"revision":null,"url":"assets/ManageIT-TPaAJ-rM.js"},{"revision":null,"url":"assets/RouteIT-CTvuoeWM.js"},{"revision":null,"url":"assets/StatusBadge-SLsZso9h.js"},{"revision":null,"url":"assets/StopDetail-CSCIUkrS.js"},{"revision":null,"url":"assets/Tab-CxtYZCns.js"},{"revision":null,"url":"assets/TeamMembers-DKTR06Po.js"},{"revision":null,"url":"assets/WorkIT-CjsNZiK_.js"},{"revision":null,"url":"assets/WorkIT-DIgwZ3u8.css"},{"revision":"854a72ba405e27326e75fc11be87a76f","url":"index.html"},{"revision":"c99db7bcfee64c71a7a3eda8c64ea230","url":"manifest.webmanifest"}]);hn();const bi=new URL(location).searchParams.get("config");try{let n=function(){return navigator.userAgent.toLowerCase().includes("chrome")};const t=st(JSON.parse(bi)),e=gi(t);mi(e,r=>{const s=r.data.title;let i={body:r.data.body||""};r.data.notification_icon&&(i.icon=r.data.notification_icon),n()?i.data={url:r.data.click_action}:r.data.click_action&&(i.actions=[{action:r.data.click_action,title:"View Details"}]),self.registration.showNotification(s,i)}),n()&&self.addEventListener("notificationclick",r=>{r.stopImmediatePropagation(),r.notification.close(),r.notification.data&&r.notification.data.url&&clients.openWindow(r.notification.data.url)})}catch(t){console.log("Failed to initialize Firebase",t)}self.skipWaiting();pn();console.log("Service Worker Initialized");
