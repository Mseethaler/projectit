 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */di();fn([{"revision":null,"url":"assets/AllocateEmployees-pwb_vcwi.js"},{"revision":null,"url":"assets/dayjs.min-DpRMKpms.js"},{"revision":null,"url":"assets/Dialog-BjMLQ5X-.js"},{"revision":null,"url":"assets/EditInstructions-BcAYqxDQ.js"},{"revision":null,"url":"assets/ErrorMessage-DMbzD5bc.js"},{"revision":null,"url":"assets/Home-BULF7irz.js"},{"revision":null,"url":"assets/index-5TMsDrzl.css"},{"revision":null,"url":"assets/index-DjOwb0aG.js"},{"revision":null,"url":"assets/index-DSxBe2in.js"},{"revision":null,"url":"assets/Login-7JwpXdZ9.js"},{"revision":null,"url":"assets/ManageIT-DEiE3-QZ.js"},{"revision":null,"url":"assets/RouteIT-DG7QrlMn.js"},{"revision":null,"url":"assets/StatusBadge-BJ0nL5gL.js"},{"revision":null,"url":"assets/StopDetail-BQFCb6jm.js"},{"revision":null,"url":"assets/Tab-BGox2xT7.js"},{"revision":null,"url":"assets/TeamMembers-DFWgoUMT.js"},{"revision":null,"url":"assets/WorkIT-CEIkgj_v.js"},{"revision":null,"url":"assets/WorkITEntries-C_TAvLIi.js"},{"revision":null,"url":"assets/WorkITEntries-DIgwZ3u8.css"},{"revision":"36c7d73cbf673e2d56b3c1e65377fe62","url":"index.html"},{"revision":"c99db7bcfee64c71a7a3eda8c64ea230","url":"manifest.webmanifest"}]);hn();const bi=new URL(location).searchParams.get("config");try{let n=function(){return navigator.userAgent.toLowerCase().includes("chrome")};const t=st(JSON.parse(bi)),e=gi(t);mi(e,r=>{const s=r.data.title;let i={body:r.data.body||""};r.data.notification_icon&&(i.icon=r.data.notification_icon),n()?i.data={url:r.data.click_action}:r.data.click_action&&(i.actions=[{action:r.data.click_action,title:"View Details"}]),self.registration.showNotification(s,i)}),n()&&self.addEventListener("notificationclick",r=>{r.stopImmediatePropagation(),r.notification.close(),r.notification.data&&r.notification.data.url&&clients.openWindow(r.notification.data.url)})}catch(t){console.log("Failed to initialize Firebase",t)}self.skipWaiting();pn();console.log("Service Worker Initialized");
