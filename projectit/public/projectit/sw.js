 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tn="FirebaseError";class N extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=Tn,Object.setPrototypeOf(this,N.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,W.prototype.create)}}class W{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},s=`${this.service}/${e}`,i=this.errors[e],a=i?kn(i,r):"Error",o=`${this.serviceName}: ${a} (${s}).`;return new N(s,o,r)}}function kn(t,e){return t.replace(An,(n,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const An=/\{\$([^}]+)}/g;function oe(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const s of n){if(!r.includes(s))return!1;const i=t[s],a=e[s];if(Me(i)&&Me(a)){if(!oe(i,a))return!1}else if(i!==a)return!1}for(const s of r)if(!n.includes(s))return!1;return!0}function Me(t){return t!==null&&typeof t=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gn{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Jn(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Jn(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ue="@firebase/app",Ue="0.11.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I=new Un("@firebase/app"),Yn="@firebase/app-compat",Xn="@firebase/analytics-compat",Qn="@firebase/analytics",Zn="@firebase/app-check-compat",er="@firebase/app-check",tr="@firebase/auth",nr="@firebase/auth-compat",rr="@firebase/database",sr="@firebase/data-connect",ir="@firebase/database-compat",ar="@firebase/functions",or="@firebase/functions-compat",cr="@firebase/installations",lr="@firebase/installations-compat",ur="@firebase/messaging",hr="@firebase/messaging-compat",dr="@firebase/performance",fr="@firebase/performance-compat",pr="@firebase/remote-config",gr="@firebase/remote-config-compat",mr="@firebase/storage",br="@firebase/storage-compat",wr="@firebase/firestore",yr="@firebase/vertexai",_r="@firebase/firestore-compat",Ir="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const he="[DEFAULT]",vr={[ue]:"fire-core",[Yn]:"fire-core-compat",[Qn]:"fire-analytics",[Xn]:"fire-analytics-compat",[er]:"fire-app-check",[Zn]:"fire-app-check-compat",[tr]:"fire-auth",[nr]:"fire-auth-compat",[rr]:"fire-rtdb",[sr]:"fire-data-connect",[ir]:"fire-rtdb-compat",[ar]:"fire-fn",[or]:"fire-fn-compat",[cr]:"fire-iid",[lr]:"fire-iid-compat",[ur]:"fire-fcm",[hr]:"fire-fcm-compat",[dr]:"fire-perf",[fr]:"fire-perf-compat",[pr]:"fire-rc",[gr]:"fire-rc-compat",[mr]:"fire-gcs",[br]:"fire-gcs-compat",[wr]:"fire-fst",[_r]:"fire-fst-compat",[yr]:"fire-vertex","fire-js":"fire-js",[Ir]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dr=1024,Or=30;class Nr{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new Lr(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}triggerHeartbeat(){return c(this,null,function*(){var e,n;try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=Fe();if(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=yield this._heartbeatsCachePromise,((n=this._heartbeatsCache)===null||n===void 0?void 0:n.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(a=>a.date===i))return;if(this._heartbeatsCache.heartbeats.push({date:i,agent:s}),this._heartbeatsCache.heartbeats.length>Or){const a=Pr(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(a,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(r){I.warn(r)}})}getHeartbeatsHeader(){return c(this,null,function*(){var e;try{if(this._heartbeatsCache===null&&(yield this._heartbeatsCachePromise),((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const n=Fe(),{heartbeatsToSend:r,unsentEntries:s}=Mr(this._heartbeatsCache.heartbeats),i=Xe(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=n,s.length>0?(this._heartbeatsCache.heartbeats=s,yield this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}catch(n){return I.warn(n),""}})}}function Fe(){return new Date().toISOString().substring(0,10)}function Mr(t,e=Dr){const n=[];let r=t.slice();for(const s of t){const i=n.find(a=>a.agent===s.agent);if(i){if(i.dates.push(s.date),je(n)>e){i.dates.pop();break}}else if(n.push({agent:s.agent,dates:[s.date]}),je(n)>e){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class Lr{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}runIndexedDBEnvironmentCheck(){return c(this,null,function*(){return Ze()?et().then(()=>!0).catch(()=>!1):!1})}read(){return c(this,null,function*(){if(yield this._canUseIndexedDBPromise){const n=yield Rr(this.app);return n!=null&&n.heartbeats?n:{heartbeats:[]}}else return{heartbeats:[]}})}overwrite(e){return c(this,null,function*(){var n;if(yield this._canUseIndexedDBPromise){const s=yield this.read();return xe(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return})}add(e){return c(this,null,function*(){var n;if(yield this._canUseIndexedDBPromise){const s=yield this.read();return xe(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return})}}function je(t){return Xe(JSON.stringify({version:2,heartbeats:t})).length}function Pr(t){if(t.length===0)return-1;let e=0,n=t[0].date;for(let r=1;r<t.length;r++)t[r].date<n&&(n=t[r].date,e=r);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Br(t){O(new T("platform-logger",e=>new Gn(e),"PRIVATE")),O(new T("heartbeat",e=>new Nr(e),"PRIVATE")),D(ue,Ue,t),D(ue,Ue,"esm2017"),D("fire-js","")}Br("");var Ur="firebase",$r="11.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */D(Ur,$r,"app");const ot="@firebase/installations",me="0.6.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ct=1e4,lt=`w:${me}`,ut="FIS_v2",xr="https://firebaseinstallations.googleapis.com/v1",Fr=60*60*1e3,jr="installations",Hr="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dt({projectId:t}){return`${xr}/projects/${t}/installations`}function ft(t){return{token:t.token,requestStatus:2,expiresIn:Wr(t.expiresIn),creationTime:Date.now()}}function pt(t,e){return c(this,null,function*(){const r=(yield e.json()).error;return k.create("request-failed",{requestName:t,serverCode:r.code,serverMessage:r.message,serverStatus:r.status})})}function gt({apiKey:t}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function Vr(t,{refreshToken:e}){const n=gt(t);return n.append("Authorization",qr(e)),n}function mt(t){return c(this,null,function*(){const e=yield t();return e.status>=500&&e.status<600?t():e})}function Wr(t){return Number(t.replace("s","000"))}function qr(t){return`${ut} ${t}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zr(r,s){return c(this,arguments,function*({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const i=dt(t),a=gt(t),o=e.getImmediate({optional:!0});if(o){const d=yield o.getHeartbeatsHeader();d&&a.append("x-firebase-client",d)}const l={fid:n,authVersion:ut,appId:t.appId,sdkVersion:lt},h={method:"POST",headers:a,body:JSON.stringify(l)},u=yield mt(()=>fetch(i,h));if(u.ok){const d=yield u.json();return{fid:d.fid||n,registrationStatus:2,refreshToken:d.refreshToken,authToken:ft(d.authToken)}}else throw yield pt("Create Installation",u)})}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jr=/^[cdef][\w-]{21}$/,fe="";function Yr(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const n=Xr(t);return Jr.test(n)?n:fe}catch(t){return fe}}function Xr(t){return Gr(t).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wt=new Map;function yt(t,e){const n=z(t);_t(n,e),Qr(n,e)}function _t(t,e){const n=wt.get(t);if(n)for(const r of n)r(e)}function Qr(t,e){const n=Zr();n&&n.postMessage({key:t,fid:e}),es()}let S=null;function Zr(){return!S&&"BroadcastChannel"in self&&(S=new BroadcastChannel("[Firebase] FID Change"),S.onmessage=t=>{_t(t.data.key,t.data.fid)}),S}function es(){wt.size===0&&S&&(S.close(),S=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ts="firebase-installations-database",ns=1,A="firebase-installations-store";let ne=null;function be(){return ne||(ne=q(ts,ns,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(A)}}})),ne}function j(t,e){return c(this,null,function*(){const n=z(t),s=(yield be()).transaction(A,"readwrite"),i=s.objectStore(A),a=yield i.get(n);return yield i.put(e,n),yield s.done,(!a||a.fid!==e.fid)&&yt(t,e.fid),e})}function It(t){return c(this,null,function*(){const e=z(t),r=(yield be()).transaction(A,"readwrite");yield r.objectStore(A).delete(e),yield r.done})}function G(t,e){return c(this,null,function*(){const n=z(t),s=(yield be()).transaction(A,"readwrite"),i=s.objectStore(A),a=yield i.get(n),o=e(a);return o===void 0?yield i.delete(n):yield i.put(o,n),yield s.done,o&&(!a||a.fid!==o.fid)&&yt(t,o.fid),o})}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function we(t){return c(this,null,function*(){let e;const n=yield G(t.appConfig,r=>{const s=rs(r),i=ss(t,s);return e=i.registrationPromise,i.installationEntry});return n.fid===fe?{installationEntry:yield e}:{installationEntry:n,registrationPromise:e}})}function rs(t){const e=t||{fid:Yr(),registrationStatus:0};return vt(e)}function ss(t,e){if(e.registrationStatus===0){if(!navigator.onLine){const s=Promise.reject(k.create("app-offline"));return{installationEntry:e,registrationPromise:s}}const n={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},r=is(t,n);return{installationEntry:n,registrationPromise:r}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:as(t)}:{installationEntry:e}}function is(t,e){return c(this,null,function*(){try{const n=yield zr(t,e);return j(t.appConfig,n)}catch(n){throw ht(n)&&n.customData.serverCode===409?yield It(t.appConfig):yield j(t.appConfig,{fid:e.fid,registrationStatus:0}),n}})}function as(t){return c(this,null,function*(){let e=yield He(t.appConfig);for(;e.registrationStatus===1;)yield bt(100),e=yield He(t.appConfig);if(e.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=yield we(t);return r||n}return e})}function He(t){return G(t,e=>{if(!e)throw k.create("installation-not-found");return vt(e)})}function vt(t){return os(t)?{fid:t.fid,registrationStatus:0}:t}function os(t){return t.registrationStatus===1&&t.registrationTime+ct<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cs(r,s){return c(this,arguments,function*({appConfig:t,heartbeatServiceProvider:e},n){const i=ls(t,n),a=Vr(t,n),o=e.getImmediate({optional:!0});if(o){const d=yield o.getHeartbeatsHeader();d&&a.append("x-firebase-client",d)}const l={installation:{sdkVersion:lt,appId:t.appId}},h={method:"POST",headers:a,body:JSON.stringify(l)},u=yield mt(()=>fetch(i,h));if(u.ok){const d=yield u.json();return ft(d)}else throw yield pt("Generate Auth Token",u)})}function ls(t,{fid:e}){return`${dt(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ye(t,e=!1){return c(this,null,function*(){let n;const r=yield G(t.appConfig,i=>{if(!Et(i))throw k.create("not-registered");const a=i.authToken;if(!e&&ds(a))return i;if(a.requestStatus===1)return n=us(t,e),i;{if(!navigator.onLine)throw k.create("app-offline");const o=ps(i);return n=hs(t,o),o}});return n?yield n:r.authToken})}function us(t,e){return c(this,null,function*(){let n=yield Ke(t.appConfig);for(;n.authToken.requestStatus===1;)yield bt(100),n=yield Ke(t.appConfig);const r=n.authToken;return r.requestStatus===0?ye(t,e):r})}function Ke(t){return G(t,e=>{if(!Et(e))throw k.create("not-registered");const n=e.authToken;return gs(n)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}function hs(t,e){return c(this,null,function*(){try{const n=yield cs(t,e),r=Object.assign(Object.assign({},e),{authToken:n});return yield j(t.appConfig,r),n}catch(n){if(ht(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))yield It(t.appConfig);else{const r=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});yield j(t.appConfig,r)}throw n}})}function Et(t){return t!==void 0&&t.registrationStatus===2}function ds(t){return t.requestStatus===2&&!fs(t)}function fs(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+Fr}function ps(t){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}function gs(t){return t.requestStatus===1&&t.requestTime+ct<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ms(t){return c(this,null,function*(){const e=t,{installationEntry:n,registrationPromise:r}=yield we(e);return r?r.catch(console.error):ye(e).catch(console.error),n.fid})}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bs(t,e=!1){return c(this,null,function*(){const n=t;return yield ws(n),(yield ye(n,e)).token})}function ws(t){return c(this,null,function*(){const{registrationPromise:e}=yield we(t);e&&(yield e)})}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ys(t){if(!t||!t.options)throw re("App Configuration");if(!t.name)throw re("App Name");const e=["projectId","apiKey","appId"];for(const n of e)if(!t.options[n])throw re(n);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}function re(t){return k.create("missing-app-config-values",{valueName:t})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ct="installations",_s="installations-internal",Is=t=>{const e=t.getProvider("app").getImmediate(),n=ys(e),r=ge(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},vs=t=>{const e=t.getProvider("app").getImmediate(),n=ge(e,Ct).getImmediate();return{getId:()=>ms(n),getToken:s=>bs(n,s)}};function Es(){O(new T(Ct,Is,"PUBLIC")),O(new T(_s,vs,"PRIVATE"))}Es();D(ot,me);D(ot,me,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const St="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",Cs="https://fcmregistrations.googleapis.com/v1",Tt="FCM_MSG",Ss="google.c.a.c_id",Ts=3,ks=1;var H;(function(t){t[t.DATA_MESSAGE=1]="DATA_MESSAGE",t[t.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(H||(H={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function b(t){const e=new Uint8Array(t);return btoa(String.fromCharCode(...e)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function As(t){const e="=".repeat((4-t.length%4)%4),n=(t+e).replace(/\-/g,"+").replace(/_/g,"/"),r=atob(n),s=new Uint8Array(r.length);for(let i=0;i<r.length;++i)s[i]=r.charCodeAt(i);return s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ns="firebase-messaging-database",Ms=1,R="firebase-messaging-store";let ie=null;function _e(){return ie||(ie=q(Ns,Ms,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(R)}}})),ie}function Ie(t){return c(this,null,function*(){const e=Ee(t),r=yield(yield _e()).transaction(R).objectStore(R).get(e);if(r)return r;{const s=yield Ds(t.appConfig.senderId);if(s)return yield ve(t,s),s}})}function ve(t,e){return c(this,null,function*(){const n=Ee(t),s=(yield _e()).transaction(R,"readwrite");return yield s.objectStore(R).put(e,n),yield s.done,e})}function Ls(t){return c(this,null,function*(){const e=Ee(t),r=(yield _e()).transaction(R,"readwrite");yield r.objectStore(R).delete(e),yield r.done})}function Ee({appConfig:t}){return t.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $s=7*24*60*60*1e3;function xs(t){return c(this,null,function*(){const e=yield js(t.swRegistration,t.vapidKey),n={vapidKey:t.vapidKey,swScope:t.swRegistration.scope,endpoint:e.endpoint,auth:b(e.getKey("auth")),p256dh:b(e.getKey("p256dh"))},r=yield Ie(t.firebaseDependencies);if(r){if(Hs(r.subscriptionOptions,n))return Date.now()>=r.createTime+$s?Fs(t,{token:r.token,createTime:Date.now(),subscriptionOptions:n}):r.token;try{yield kt(t.firebaseDependencies,r.token)}catch(s){console.warn(s)}return qe(t.firebaseDependencies,n)}else return qe(t.firebaseDependencies,n)})}function We(t){return c(this,null,function*(){const e=yield Ie(t.firebaseDependencies);e&&(yield kt(t.firebaseDependencies,e.token),yield Ls(t.firebaseDependencies));const n=yield t.swRegistration.pushManager.getSubscription();return n?n.unsubscribe():!0})}function Fs(t,e){return c(this,null,function*(){try{const n=yield Us(t.firebaseDependencies,e),r=Object.assign(Object.assign({},e),{token:n,createTime:Date.now()});return yield ve(t.firebaseDependencies,r),n}catch(n){throw n}})}function qe(t,e){return c(this,null,function*(){const r={token:yield Bs(t,e),createTime:Date.now(),subscriptionOptions:e};return yield ve(t,r),r.token})}function js(t,e){return c(this,null,function*(){const n=yield t.pushManager.getSubscription();return n||t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:As(e)})})}function Hs(t,e){const n=e.vapidKey===t.vapidKey,r=e.endpoint===t.endpoint,s=e.auth===t.auth,i=e.p256dh===t.p256dh;return n&&r&&s&&i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ks(t){const e={from:t.from,collapseKey:t.collapse_key,messageId:t.fcmMessageId};return Vs(e,t),Ws(e,t),qs(e,t),e}function Vs(t,e){if(!e.notification)return;t.notification={};const n=e.notification.title;n&&(t.notification.title=n);const r=e.notification.body;r&&(t.notification.body=r);const s=e.notification.image;s&&(t.notification.image=s);const i=e.notification.icon;i&&(t.notification.icon=i)}function Ws(t,e){e.data&&(t.data=e.data)}function qs(t,e){var n,r,s,i,a;if(!e.fcmOptions&&!(!((n=e.notification)===null||n===void 0)&&n.click_action))return;t.fcmOptions={};const o=(s=(r=e.fcmOptions)===null||r===void 0?void 0:r.link)!==null&&s!==void 0?s:(i=e.notification)===null||i===void 0?void 0:i.click_action;o&&(t.fcmOptions.link=o);const l=(a=e.fcmOptions)===null||a===void 0?void 0:a.analytics_label;l&&(t.fcmOptions.analyticsLabel=l)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zs(t){return typeof t=="object"&&!!t&&Ss in t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gs(t){return new Promise(e=>{setTimeout(e,t)})}function Js(t,e){return c(this,null,function*(){const n=Ys(e,yield t.firebaseDependencies.installations.getId());Xs(t,n,e.productId)})}function Ys(t,e){var n,r;const s={};return t.from&&(s.project_number=t.from),t.fcmMessageId&&(s.message_id=t.fcmMessageId),s.instance_id=e,t.notification?s.message_type=H.DISPLAY_NOTIFICATION.toString():s.message_type=H.DATA_MESSAGE.toString(),s.sdk_platform=Ts.toString(),s.package_name=self.origin.replace(/(^\w+:|^)\/\//,""),t.collapse_key&&(s.collapse_key=t.collapse_key),s.event=ks.toString(),!((n=t.fcmOptions)===null||n===void 0)&&n.analytics_label&&(s.analytics_label=(r=t.fcmOptions)===null||r===void 0?void 0:r.analytics_label),s}function Xs(t,e,n){const r={};r.event_time_ms=Math.floor(Date.now()).toString(),r.source_extension_json_proto3=JSON.stringify({messaging_client_event:e}),n&&(r.compliance_data=Qs(n)),t.logEvents.push(r)}function Qs(t){return{privacy_context:{prequest:{origin_associated_product_id:t}}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zs(t,e){return c(this,null,function*(){var n,r;const{newSubscription:s}=t;if(!s){yield We(e);return}const i=yield Ie(e.firebaseDependencies);yield We(e),e.vapidKey=(r=(n=i==null?void 0:i.subscriptionOptions)===null||n===void 0?void 0:n.vapidKey)!==null&&r!==void 0?r:St,yield xs(e)})}function ei(t,e){return c(this,null,function*(){const n=ri(t);if(!n)return;e.deliveryMetricsExportedToBigQueryEnabled&&(yield Js(e,n));const r=yield Rt();if(ii(r))return ai(r,n);if(n.notification&&(yield oi(ni(n))),!!e&&e.onBackgroundMessageHandler){const s=Ks(n);typeof e.onBackgroundMessageHandler=="function"?yield e.onBackgroundMessageHandler(s):e.onBackgroundMessageHandler.next(s)}})}function ti(t){return c(this,null,function*(){var e,n;const r=(n=(e=t.notification)===null||e===void 0?void 0:e.data)===null||n===void 0?void 0:n[Tt];if(r){if(t.action)return}else return;t.stopImmediatePropagation(),t.notification.close();const s=ci(r);if(!s)return;const i=new URL(s,self.location.href),a=new URL(self.location.origin);if(i.host!==a.host)return;let o=yield si(i);if(o?o=yield o.focus():(o=yield self.clients.openWindow(s),yield Gs(3e3)),!!o)return r.messageType=K.NOTIFICATION_CLICKED,r.isFirebaseMessaging=!0,o.postMessage(r)})}function ni(t){const e=Object.assign({},t.notification);return e.data={[Tt]:t},e}function ri({data:t}){if(!t)return null;try{return t.json()}catch(e){return null}}function si(t){return c(this,null,function*(){const e=yield Rt();for(const n of e){const r=new URL(n.url,self.location.href);if(t.host===r.host)return n}return null})}function ii(t){return t.some(e=>e.visibilityState==="visible"&&!e.url.startsWith("chrome-extension://"))}function ai(t,e){e.isFirebaseMessaging=!0,e.messageType=K.PUSH_RECEIVED;for(const n of t)n.postMessage(e)}function Rt(){return self.clients.matchAll({type:"window",includeUncontrolled:!0})}function oi(t){var e;const{actions:n}=t,{maxActions:r}=Notification;return n&&r&&n.length>r&&console.warn(`This browser only supports ${r} actions. The remaining actions will not be displayed.`),self.registration.showNotification((e=t.title)!==null&&e!==void 0?e:"",t)}function ci(t){var e,n,r;const s=(n=(e=t.fcmOptions)===null||e===void 0?void 0:e.link)!==null&&n!==void 0?n:(r=t.notification)===null||r===void 0?void 0:r.click_action;return s||(zs(t.data)?self.location.origin:null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ui{constructor(e,n,r){this.deliveryMetricsExportedToBigQueryEnabled=!1,this.onBackgroundMessageHandler=null,this.onMessageHandler=null,this.logEvents=[],this.isLogServiceStarted=!1;const s=li(e);this.firebaseDependencies={app:e,appConfig:s,installations:n,analyticsProvider:r}}_delete(){return Promise.resolve()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hi=t=>{const e=new ui(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return self.addEventListener("push",n=>{n.waitUntil(ei(n,e))}),self.addEventListener("pushsubscriptionchange",n=>{n.waitUntil(Zs(n,e))}),self.addEventListener("notificationclick",n=>{n.waitUntil(ti(n))}),e};function di(){O(new T("messaging-sw",hi,"PUBLIC"))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fi(){return c(this,null,function*(){return Ze()&&(yield et())&&"PushManager"in self&&"Notification"in self&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pi(t,e){if(self.document!==void 0)throw g.create("only-available-in-sw");return t.onBackgroundMessageHandler=e,()=>{t.onBackgroundMessageHandler=null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gi(t=Tr()){return fi().then(e=>{if(!e)throw g.create("unsupported-browser")},e=>{throw g.create("indexed-db-unsupported")}),ge(tt(t),"messaging-sw").getImmediate()}function mi(t,e){return t=tt(t),pi(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */di();fn([{"revision":null,"url":"assets/AllocateEmployees-CeGI5VSi.js"},{"revision":null,"url":"assets/dayjs.min-BruSiLTk.js"},{"revision":null,"url":"assets/Dialog-30Oj0Xbn.js"},{"revision":null,"url":"assets/EditInstructions-BfdVjE2z.js"},{"revision":null,"url":"assets/ErrorMessage-DrO5fk2f.js"},{"revision":null,"url":"assets/Home-4k58cdgx.js"},{"revision":null,"url":"assets/index-5TMsDrzl.css"},{"revision":null,"url":"assets/index-CJCGlGSL.js"},{"revision":null,"url":"assets/index-r6M-7ACY.js"},{"revision":null,"url":"assets/Login-DsGnIaC_.js"},{"revision":null,"url":"assets/ManageIT-Dg5ax1CA.js"},{"revision":null,"url":"assets/RouteIT-DQpMQoe7.js"},{"revision":null,"url":"assets/StatusBadge-jV0WU3-L.js"},{"revision":null,"url":"assets/StopDetail-BFD8jN_T.js"},{"revision":null,"url":"assets/Tab-UDAvkb0c.js"},{"revision":null,"url":"assets/TeamMembers-DHPyrmkK.js"},{"revision":null,"url":"assets/WorkIT-_AfRATEP.js"},{"revision":null,"url":"assets/WorkITEntries-BHBcWRik.js"},{"revision":null,"url":"assets/WorkITEntries-DIgwZ3u8.css"},{"revision":"185566ba2534beec118e7a68e2f3a0a6","url":"index.html"},{"revision":"c99db7bcfee64c71a7a3eda8c64ea230","url":"manifest.webmanifest"}]);hn();const bi=new URL(location).searchParams.get("config");try{let n=function(){return navigator.userAgent.toLowerCase().includes("chrome")};const t=st(JSON.parse(bi)),e=gi(t);mi(e,r=>{const s=r.data.title;let i={body:r.data.body||""};r.data.notification_icon&&(i.icon=r.data.notification_icon),n()?i.data={url:r.data.click_action}:r.data.click_action&&(i.actions=[{action:r.data.click_action,title:"View Details"}]),self.registration.showNotification(s,i)}),n()&&self.addEventListener("notificationclick",r=>{r.stopImmediatePropagation(),r.notification.close(),r.notification.data&&r.notification.data.url&&clients.openWindow(r.notification.data.url)})}catch(t){console.log("Failed to initialize Firebase",t)}self.skipWaiting();pn();console.log("Service Worker Initialized");
